...
const calcDisplaySummary = function (acc) {
  ...
  labelSumln.textContent = `${incomes}€`;
...
function checkDogs(dogsJulia, dogsKate) {
  // 1. Копираме масива на Julia и премахваме първия и последните два елемента
  const correctedJulia = dogsJulia.slice(1, -2);

  // 2. Обединяваме коригирания масив на Julia с този на Kate
  const allDogs = correctedJulia.concat(dogsKate);

  // 3. Обхождаме масива и проверяваме възрастта на всяко куче
...
// 4. Тестваме функцията с дадените тестови данни
